    ...
    public void getSongList(){
        ...
        if (musicCursor!= null && musicCursor.moveToFirst()){
            ...
            do {
                ...
                String thisTitle = musicCursor.getString(titleColumn); String thisArtist = musicCursor.getString(artistColumn);
    ...
    private void setController() {
        ...
        controller .setPrevNextListeners( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                playNext(); } }, new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                playPrev(); } }); controller .setMediaPlayer( this );
